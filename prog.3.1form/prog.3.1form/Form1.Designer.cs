namespace prog._3._1form
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Введите начало диапазона А";
			// 
			// numericUpDown1
			// 
			this.numericUpDown1.Location = new System.Drawing.Point(191, 33);
			...
			this.label2.Text = "Введите конец диапазона B";
			// 
			// numericUpDown2
			// 
			this.numericUpDown2.Location = new System.Drawing.Point(191, 66);
